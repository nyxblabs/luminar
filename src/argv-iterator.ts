...
export type Index = | [index: number] | [index: number, aliasIndex: number, isLast: boolean]
...
export function parseLuminarArgv(luminarArgv: string): [
  luminarName: string,
  luminarValue:string | undefined, isAlias: boolean,
] | undefined {
...
export function argvIterator(argv: string[],
   {
      onLuminar,
      onArgument,
   }: {
...
export function spliceFromArgv(argv: string[],
   removeArgvs: Index[]) {
